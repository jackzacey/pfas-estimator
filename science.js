const SCIENCE = {
  ...
  "Lithium": {
    ...
    thyroid: "Lithium accumulates in thyroid tissue at 3-4x plasma concentrations, directly inhibiting thyroid hormone synthesis and release. Unlike PFAS compounds, lithium is naturally occurring — it enters water through geological leaching, not industrial contamination. An environmental study from Argentina found adverse thyroid homeostasis during pregnancy at water concentrations above approximately 5 µg/L, disrupting thyroid function at the pituitary level and through thyroid hormone transport proteins.",
    health_effects: "Lithium presents a scientifically unique dual-effect paradox. Harmful associations: thyroid disruption (most consistently documented adverse effect — meets WHO definition of thyroid hormone system disruptor), ASD risk (JAMA Pediatrics 2023 Danish study of 8,842 cases found OR 1.23 per IQR increase in maternal prenatal drinking water lithium, OR 1.46 at highest quartile >16.78 µg/L), schizophrenia risk (up to 1.88-fold increase across 0.6–30.7 µg/L range studied). Beneficial associations at population level: inverse association with suicide mortality (meta-analysis of 9 studies) and lower dementia/Alzheimer's incidence. Critical tension: the harmful and beneficial signals overlap across the same concentration range. No bioaccumulation — half-life ~24 hours at environmental doses.",
    clinical_threshold: "No federal MCL or Health Advisory. EPA non-regulatory Health Reference Level (HRL): 10 µg/L. ASD risk signal begins at >7.36 µg/L — below the EPA's own HRL. Schizophrenia signal spans the entire studied range (0.6–30.7 µg/L). Thyroid effects during pregnancy suggested above ~5 µg/L. EPA Final Regulatory Determination 5 (March 2026) will determine whether a formal MCL is warranted. 24–28% of U.S. public water systems exceed the 10 µg/L HRL.",
    actionable: "NSF/ANSI 58-certified reverse osmosis filter removes lithium. For pregnant women: the ASD and schizophrenia risk signals beginning below 10 µg/L make this the most clinically actionable concern — discuss with your OB-GYN, particularly if you're in a western U.S. state (Montana, Wyoming, Colorado, Utah, Nevada, Arizona, New Mexico, Texas) where groundwater lithium is highest. Thyroid function monitoring (TSH, free T4) is appropriate. Unlike PFAS, serum testing is not useful for environmental lithium — levels are undetectable at water-level exposure.",
    evidence_note: "Lithium is fundamentally different from PFAS — naturally occurring, not industrial. However, 'natural' does not mean safe. The ASD risk signal in a nationwide Danish study begins at concentrations below the EPA's own non-regulatory threshold. EPA's regulatory determination in March 2026 will be the most significant development to watch.",
    epa_limit: null
  }
};
